...
const categorias = [
  ...
  },
  {
    ...
    subcategories: ["ACCESORIOS PARA VIAJE", "CANGURERA Y MOCHILA DE VIAJE", "LENTES", "ORGANIZADORES", "PORTA DOCUMENTOS", "NECESER"],
    image: "/cat-viaje.jpg",
    barColor: "bg-[#462681]",
    slug: "viaje",
  },
      ...
      <div className="w-full px-2 md:pl-4 md:pr-6 py-4 md:py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
          {categorias.map((cat) => (
            <div
              key={cat.title}
              className="rounded-xl overflow-hidden border border-gray-200 dark:border-white/10 shadow-sm will-change-transform transition-all duration-[240ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] hover:-translate-y-2 hover:scale-[1.05] hover:shadow-[0_18px_40px_rgba(0,0,0,0.16)] hover:z-10 active:-translate-y-[3px] active:scale-[1.02]"
            >
