            ...
            <div className="flex flex-col items-center text-center">
              <h3 className="font-['Montserrat'] text-[26px] md:text-[28px] lg:text-[32px] font-semibold text-[#111111]">
                ...
                <div className="flex items-center justify-center gap-[14px] md:gap-[18px] lg:gap-[22px] mt-3 md:mt-4 lg:mt-5">
                  ...
                  >
                    <img
                      src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/227d548b-b8f5-4d86-a14b-344106766009/disenare-maqueta-06-1770149849866.png?width=600&height=600&resize=contain"
                      alt="Instagram"
                      width={600}
                      height={600}
                      className="w-[600px] h-[600px] object-contain block"
                    />
                  </a>
                  ...
                  >
                    <img
                      src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/227d548b-b8f5-4d86-a14b-344106766009/disenare-maqueta-09-1770149791022.png?width=600&height=600&resize=contain"
                      alt="Facebook"
                      width={600}
                      height={600}
                      className="w-[600px] h-[600px] object-contain block"
                  ...
                  >
                    <img
                      src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/227d548b-b8f5-4d86-a14b-344106766009/disenare-maqueta-07-1770149779669.png?width=600&height=600&resize=contain"
                      alt="WhatsApp"
                      width={600}
                      height={600}
                      className="w-[600px] h-[600px] object-contain block"
                  ...
                  >
                    <img
                      src="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/render/image/public/project-uploads/227d548b-b8f5-4d86-a14b-344106766009/disenare-maqueta-08-1770149787870.png?width=600&height=600&resize=contain"
                      alt="Email"
                      width={600}
                      height={600}
                      className="w-[600px] h-[600px] object-contain block"
