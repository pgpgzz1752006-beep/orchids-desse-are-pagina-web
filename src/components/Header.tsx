  ...
  return (
    <header className="w-full bg-white dark:bg-[#0E0F12]">
      ...
      <div className="w-full grid grid-cols-[auto_1fr_auto] items-center gap-x-6 h-[90px] md:h-[120px] lg:h-[220px] pl-3 pr-4 md:pl-4 md:pr-6 lg:pl-4 lg:pr-6">
        ...
        <nav className="hidden lg:flex items-center justify-self-center min-w-0 max-w-[820px] w-full justify-center gap-5 xl:gap-9 2xl:gap-14 overflow-visible flex-nowrap mr-12 xl:mr-16">
          {navItems.map((item) => (
            <a
              key={item.label}
              href={item.href}
