          ...
          <div className="justify-self-start flex-shrink-0 flex items-center">
            <a href="/" className="relative flex items-center overflow-visible h-[70px] w-[160px] md:h-[100px] md:w-[230px] lg:h-[200px] lg:w-[420px]">
                  ...
                  <Image
                    ...
                    width={420}
                    height={200}
                    className="absolute left-[6px] top-1/2 -translate-y-1/2 h-[86%] w-auto object-contain object-left-center hidden dark:block transition-opacity duration-[180ms] ease-in-out"
                    priority
                  />
                </a>
            </div>
