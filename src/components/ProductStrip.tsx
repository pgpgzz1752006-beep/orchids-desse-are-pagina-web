    ...
    <section className="w-full bg-white py-14 md:py-16 lg:py-[72px]">
      <div className="w-full max-w-[1320px] mx-auto px-6 md:px-10 lg:px-10">
        ...
        >
          ...
          <div 
            ref={containerRef}
            className="w-full md:px-14 lg:px-16 overflow-hidden select-none"
            ...
            >
              {extendedProducts.map((product, index) => (
                ...
                >
                  <a
                    href={product.href}
                    className="block bg-white border border-[#D9D9D9] rounded-[11px] p-3 lg:p-[14px] flex flex-col transition-all duration-180 ease-out hover:border-[#BBBBBB] hover:-translate-y-[2px] hover:shadow-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-[#14C6C9]/40"
