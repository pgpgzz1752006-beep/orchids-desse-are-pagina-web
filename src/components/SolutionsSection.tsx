  ...
  return (
    <section className="w-full bg-white dark:bg-[#0E0F12] py-16 md:py-20 lg:py-16 transition-colors duration-300">
      <div className="w-full max-w-[1280px] mx-auto px-5 md:px-8 lg:px-8">
        {/* Title */}
        <h2 className="text-center font-['Montserrat'] text-[30px] md:text-[38px] lg:text-[44px] tracking-[0.03em] text-[#111111] dark:text-[#F2F2F2] mb-5">
          <span className="font-normal">NUESTRAS </span>
          <span className="font-extrabold">SOLUCIONES</span>
        </h2>

        {/* Description */}
        <p className="text-center font-['Montserrat'] text-[14px] md:text-[15px] lg:text-[15px] leading-[1.7] text-[#2F2F2F] dark:text-[#CCCCCC] max-w-[880px] mx-auto mb-10 md:mb-12 lg:mb-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-6 py-4">
              ...
              <div className="w-[56px] h-[56px] md:w-[64px] md:h-[64px] lg:w-[72px] lg:h-[72px] bg-white rounded-[14px] lg:rounded-[16px] flex items-center justify-center mb-4">
                <img
                  ...
                  width={72}
                  height={72}
                  className="w-[450px] h-[450px] md:w-[450px] md:h-[450px] lg:w-[450px] lg:h-[450px] object-contain block"
                />
              </div>

              {/* Title */}
              <h3 className="font-['Montserrat'] text-[16px] lg:text-[17px] font-bold text-[#111111] dark:text-[#F2F2F2] mb-2">
                {solution.title}
              </h3>

              {/* Description */}
              <p className="font-['Montserrat'] text-[13px] lg:text-[13.5px] leading-[1.6] text-[#4A4A4A] dark:text-[#AAAAAA] min-h-[72px]">
